    ...
    <main className="min-h-dvh">
      ...
      <section className="mx-auto max-w-4xl">
        <MaxWidthWrapper className="space-y-4 py-12">
          ...
          <div>
            <h3 className="font-bold">How do we process your information?</h3>
            <p>
          ...
          <div>
            <h3 className="font-bold">What are your rights?</h3>
            <p>
          ...
          <div>
            <h3 className="font-bold">How do you exercise your rights?</h3>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold">WHAT ARE YOUR PRIVACY RIGHTS?</h2>
          </div>
          ...
          <div>
            <p>
              ...
              may email us at Weddings@RLMAffairs.com.
            </p>
          </div>
          ...
          <div>
            <h3 className="font-bold">How to Exercise Your Rights</h3>
            <p>
              To exercise these rights, you can contact us by submitting a data
              subject access request, by emailing us at Weddings@RLMAffairs.com,
          ...
          <div>
            ...
            <p>
              ...
              emailing us at Weddings@RLMAffairs.com. We will inform you in
              writing of any action taken or not taken in response to the
              appeal, including a written explanation of the reasons for the
              decisions. If your appeal is denied, you may submit a complaint to
          ...
          <div>
            ...
            <p className="pb-2">
              ...
              us at Weddings@RLMAffairs.com or contact us by post at:
            </p>
            <p>
              RLM Affairs
              <br />
          ...
          <div>
            ...
            <p>
              ...
              to our processing of your personal information. However, we do not
